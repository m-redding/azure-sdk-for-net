...
namespace System.ClientModel.Tests.Internal.ModelReaderWriterTests
{
    public class JsonPathReaderTests
    {
        ...
        public void Current_InitialState_IsDefault()
        {
            ...
            Assert.That(reader.Current.TokenType, Is.EqualTo(defaultToken.TokenType));
            Assert.That(reader.Current.TokenStartIndex, Is.EqualTo(defaultToken.TokenStartIndex));
            Assert.That(reader.Current.ValueSpan.SequenceEqual(defaultToken.ValueSpan), Is.True, $"Expected empty span but got '{Encoding.UTF8.GetString(reader.Current.ValueSpan.ToArray())}'");
        }
