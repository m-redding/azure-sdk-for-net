...
/// <summary/>
///
public class BurstProcessorTest : TestScenario
{
    /// <summary> The name of this test.</summary>
    public override string Name { get; } = "BurstProcessorTest";
    ...
    ///
    public BurstProcessorTest(TestParameters testParameters,
                         Metrics metrics) : base(testParameters, metrics, $"net-burstproc-{Guid.NewGuid()}")
    {
    }
                              ...
                              CancellationToken cancellationToken)
    {
        ...
        switch (role)
        {
            case Role.Processor:
                ...
                Console.WriteLine("Starting to process events");
    ...
    private Task ProcessEventHandler(ProcessEventArgs args)
    {
        ...
        try
        {
            ...
            if (args.HasEvent)
            {
                ...
                Console.WriteLine($"Processor {_identifier} has processed an event for partition {args.Partition}");
